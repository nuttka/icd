...
Original file is located at
    https://colab.research.google.com/drive/16O7ErRU2iE3ndyAFFqDhjLDU-JKxyGbK
...
def percent(df1, df2, column, alpha):
  ...
  # entre as medianas testadas
    ...
    values_diff = np.zeros(n)
    for i in range(n):
        sample_1 = df1[column].sample(len(df1), replace=True, random_state = i)
        sample_2 = df2[column].sample(len(df2),replace=True, random_state = i*3)
        values_diff[i] = sample_1.median() - sample_2.median()
