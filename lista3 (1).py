...
Original file is located at
    https://colab.research.google.com/drive/1gWIUCN7Dvfe0CrZtWIDt8gbDFOgBH_bM
...
# def high_delay(df):
    # df_without_cancelled = df[df['Cancelled'] == 0]
    # df_group = df_without_cancelled.groupby(['OriginAirportName', 'DestAirportName'])
    # high_time_mean = 0
    # origin = ""
    # dest = ""

    # for group_key, group_value in df_group:
    #     group = df_group.get_group(group_key)
    #     # time_mean = group['CRSArrTime'].mean() + group['ArrDelay'].mean() - (group['CRSDepTime'].mean() + group['DepDelay'].mean())
    #     time_mean = group['CRSArrTime'].mean()- (group['CRSDepTime'].mean())
        
    #     # print(time_mean, " segundo: ", time2, "partida: ",df.iloc[group.index[0]]['OriginAirportName'], " destino: ",df.iloc[group.index[0]]['DestAirportName'] )
